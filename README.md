...
TODO :
- Appeler la route serveur pour valider l'auth et passer d'un JWT Auth à un Session token, à faire dans storage/database.rs::init_device_storage()
- Créer la route sur le serveur qui transforme notre JWT Auth en Session token
